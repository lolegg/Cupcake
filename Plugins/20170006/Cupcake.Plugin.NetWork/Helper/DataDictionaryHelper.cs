...
namespace Cupcake.Plugin.NetWork.Helper
{
    public static class DataDictionaryHelper
    {
        ...
        public static string GetType(Guid? Id)
        {
            var query = new Repository<FormDownload>().TableNoTracking;
            return query.Where(n => n.Id == Id).FirstOrDefault().Title;
        }
