...
{
    //财政资金信息
   public class MessageOpenMoneyMessageModel:BaseModel
    {
        [Required]
        [Display(Name = "标题")]
        ...
        public MessageOpenMoneyMessageInfo ToInfo()
        {
            MessageOpenMoneyMessageInfo info = new MessageOpenMoneyMessageInfo();
        ...
        public MessageOpenMoneyMessageModel ToModel(MessageOpenMoneyMessageInfo info)
        {
            this.Id = info.Id;
        ...
        public MessageOpenMoneyMessageInfo FormData(MessageOpenMoneyMessageInfo info)
        {
            info.Title = this.Title;
            info.publicName = this.publicName;
            info.Content = this.Content;
