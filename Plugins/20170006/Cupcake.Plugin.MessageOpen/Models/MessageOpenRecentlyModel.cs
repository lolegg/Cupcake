...
{
    //近期信息公开
    public class MessageOpenRecentlyModel : BaseModel
    {
        [Required]
        [Display(Name = "标题")]
        ...
        public MessageOpenRecentlyInfo ToInfo()
        {
            MessageOpenRecentlyInfo info = new MessageOpenRecentlyInfo();
        ...
        public MessageOpenRecentlyModel ToModel(MessageOpenRecentlyInfo info)
        {
            this.Id = info.Id;
        ...
        public MessageOpenRecentlyInfo FormData(MessageOpenRecentlyInfo info)
        {
            info.Title = this.Title;
            info.publicName = this.publicName;
            info.Content = this.Content;
