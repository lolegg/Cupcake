...
{
    public class MessageOpenNormativeFileModel : BaseModel
    {
        ...
        public MessageOpenNormativeFileInfo ToInfo()
        {
            MessageOpenNormativeFileInfo info = new MessageOpenNormativeFileInfo();
        ...
        public MessageOpenNormativeFileModel ToModel(MessageOpenNormativeFileInfo info)
        {
            this.Id = info.Id;
        ...
        public MessageOpenNormativeFileInfo FormData(MessageOpenNormativeFileInfo info)
        {
            info.Title = this.Title;
            info.publicName = this.publicName;
            info.Content = this.Content;
