...
{
   public class MessageOpenAdministrativeIndexController:Controller
    {
       private readonly IMessageOpenAdministrativeIndexService service;
       public MessageOpenAdministrativeIndexController(IMessageOpenAdministrativeIndexService baseService)
       {
           this.service = baseService;
       }
       public ActionResult Index(MessageOpenAdministrativeIndexCondition condition)
        {
            var info = service.SearchNews(condition);
            var models = new PagedList<MessageOpenAdministrativeIndexInfo>(info, info.Paging);
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Create(MessageOpenAdministrativeIndexModel model)
        {
        ...
        public ActionResult Edit(Guid id)
        {
            ...
            ViewBag.Organization = DataDictionaryHelper.GetOrganizationList();
            var model = new MessageOpenAdministrativeIndexModel().ToModel(info);
            var name = Session["User"] as User;
            model.publicName = name.Name;
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Edit(MessageOpenAdministrativeIndexModel model)
        {
