...
{
   public class MessageOpenRightDutyListingController:Controller
    {

       private readonly IMessageOpenRightDutyListingService service;
       public MessageOpenRightDutyListingController(IMessageOpenRightDutyListingService baseService)
       {
           this.service = baseService;
       }
       public ActionResult Index(MessageOpenRightDutyListingCondition condition)
        {
            var info = service.SearchNews(condition);
            var models = new PagedList<MessageOpenRightDutyListingInfo>(info, info.Paging);
        ...
        {
            var model = new MessageOpenRightDutyListingModel();
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Create(MessageOpenRightDutyListingModel model)
        {
