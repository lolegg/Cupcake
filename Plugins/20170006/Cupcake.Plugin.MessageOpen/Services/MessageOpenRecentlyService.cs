...
{
    //近期信息公开
    public partial class MessageOpenRecentlyService : PluginBaseService<MessageOpenRecentlyInfo>, IMessageOpenRecentlyService
    {
        public MessageOpenRecentlyService(IRepository<MessageOpenRecentlyInfo> repository)
            : base(repository)
        {
         
        }

        public IPagedList<MessageOpenRecentlyInfo> SearchNews(MessageOpenRecentlyCondition condition)
        {
            ...
            return new PagedList<MessageOpenRecentlyInfo>(query, condition.PageIndex, condition.PageSize);
        }
    }
}
