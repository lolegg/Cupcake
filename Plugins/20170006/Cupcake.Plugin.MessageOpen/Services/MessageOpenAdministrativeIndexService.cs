...
{
    //行政许可事项目录
    public partial class MessageOpenAdministrativeIndexService : PluginBaseService<MessageOpenAdministrativeIndexInfo>, IMessageOpenAdministrativeIndexService
    {
        public MessageOpenAdministrativeIndexService(IRepository<MessageOpenAdministrativeIndexInfo> repository)
            : base(repository)
        {
         
        }
          public IPagedList<MessageOpenAdministrativeIndexInfo> SearchNews(MessageOpenAdministrativeIndexCondition condition)
        {
            ...
            return new PagedList<MessageOpenAdministrativeIndexInfo>(query, condition.PageIndex, condition.PageSize);
        }
   }
}
