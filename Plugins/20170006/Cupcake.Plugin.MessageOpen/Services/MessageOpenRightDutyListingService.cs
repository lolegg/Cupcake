...
{
    //权利清单和责任清单
    public partial class MessageOpenRightDutyListingService : PluginBaseService<MessageOpenRightDutyListingInfo>, IMessageOpenRightDutyListingService
    {
        public MessageOpenRightDutyListingService(IRepository<MessageOpenRightDutyListingInfo> repository)
            : base(repository)
        {
         
        }

         public IPagedList<MessageOpenRightDutyListingInfo> SearchNews(MessageOpenRightDutyListingCondition condition)
        {
            ...
            return new PagedList<MessageOpenRightDutyListingInfo>(query, condition.PageIndex, condition.PageSize);
        }
    }
}
