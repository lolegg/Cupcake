...
namespace Cupcake.Data
{
    public static class DbContextExtensions
    {
        ...
        private static T InnerGetCopy<T>(IDbContext context, T currentCopy, Func<DbEntityEntry<T>, DbPropertyValues> func) where T : PluginBaseEntity
        {
        ...
        /// <returns></returns>
        private static DbEntityEntry<T> GetEntityOrReturnNull<T>(T currentCopy, DbContext dbContext) where T : PluginBaseEntity
        {
        ...
        /// <param name="currentCopy">The current copy.</param>
        /// <returns></returns>
        public static T LoadOriginalCopy<T>(this IDbContext context, T currentCopy) where T : PluginBaseEntity
        {
        ...
        /// <param name="currentCopy">The current copy.</param>
        /// <returns></returns>
        public static T LoadDatabaseCopy<T>(this IDbContext context, T currentCopy) where T : PluginBaseEntity
        {
        ...
        public static string GetTableName<T>(this IDbContext context) where T : PluginBaseEntity
        {
